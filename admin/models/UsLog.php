 ...
 */
class UsLog extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['us_log_consulta_fecha', 'us_log_origen', 'us_log_destino'], 'required'],
            [['us_log_consulta_fecha'], 'safe'],
            [['us_log_origen', 'us_log_destino'], 'integer'],
            [['us_log_origen'], 'exist', 'skipOnError' => true, 'targetClass' => GeoUbicacion::className(), 'targetAttribute' => ['us_log_origen' => 'geo_ubicacion_id']],
            [['us_log_destino'], 'exist', 'skipOnError' => true, 'targetClass' => GeoUbicacion::className(), 'targetAttribute' => ['us_log_destino' => 'geo_ubicacion_id']],
        ];
    }
