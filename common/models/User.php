...
class User extends ActiveRecord implements IdentityInterface {
    ...
    public static function isUserSimple($id){
        if(static::find()
                ->where(['us_cuenta_id'=>$id, 'us_estado_usuario_id'=>  self::STATUS_ACTIVE])
                ->andWhere('us_estado_usuario>=1')
                ){
            return true;
        }
        else{
    ...
    public static function findIdentity($id) {
        return static::findOne(['us_cuenta_id' => $id, 'us_estado_usuario' => 'activo']);
    }
    ...
    public static function findByUsername($username) {
        return static::findOne(['us_correo' => $username, 'us_estado_usuario' => 'activo']);
    }
    ...
    public static function findByPasswordResetToken($token) {
        ...
        return static::findOne([
                    ...
                    'us_estado_usuario_id' => self::STATUS_ACTIVE,
        ]);
    }
